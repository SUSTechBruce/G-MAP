...
parser.add_argument('--data_dir', type=str, help='Path to data directory', default='/home/wan/Desktop/Brucewan/video_scratch/Brucewan/emrQA/new_outputs')
parser.add_argument('--filename', type=str, help='Filename for sample', default='dev')
parser.add_argument('--out_dir', type=str, help='Path to output file dir', default='/home/wan/Desktop/Brucewan/video_scratch/Brucewan/emrQA/new_outputs')
