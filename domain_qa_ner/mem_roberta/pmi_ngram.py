...
parser.add_argument('--dataset', type=str, required=True, default='/home/jagan/Brucewan/new_T-DNA/T-DNA/data/chemprot/train.tsv',help="the name of dataset")
parser.add_argument('--output_dir', type=str, required=True, default='/home/jagan/Brucewan/new_T-DNA/T-DNA/ngram/chemprot', help="the output path")
