...
class RobertaEncoder(nn.Module): # Here are the main model
    ...
    def forward( # attention mask is for the padding token
        ...
        for i, layer_module in enumerate(self.layer): # for every layer
            ...
            # layer_output[1] is the output attentiond
            hidden_states = layer_outputs[0] # layer_outputs[0] is hidden_states
...
class RobertaModel(RobertaPreTrainedModel): # Main roberta model for TDNA
