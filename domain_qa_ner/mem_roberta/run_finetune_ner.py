...
##################### Add from roberta modeling ##############################
from roberta_modeling import RobertaModel
from mem_atten_modeling import RobertaForTokenClassification
...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        print('Show training_args ################################', training_args)
    else:
    ...
    n_gpu=1,
        ...
        log_level=-1,
        log_level_replica=-1,
        log_on_each_node=True,s
        logging_dir=./roberta_base_cased_conll2003/runs/May10_19-40-40_jing,
        ...
        output_dir=./roberta_base_cased_conll2003,
        ...
        run_name=./roberta_base_cased_conll2003,
    ...
    if data_args.dataset_name is not None:
        ...
        dataset_name = '/home/wan/Desktop/Brucewan/video_scratch/Brucewan/MemoryBert/MemRoberta/data_ner/ncbi_disease/ncbi_disease.py'
        # dataset_name = '/home/wan/Desktop/Brucewan/video_scratch/Brucewan/MemoryBert/MemRoberta/data_ner/wnut_17/wnut_17.py'
    ...
    # Metrics
    metric = load_metric('/home/wan/Desktop/Brucewan/video_scratch/Brucewan/MemoryBert/MemRoberta/mem_roberta/seqeval.py')
