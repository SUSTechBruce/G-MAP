...
from ensemble_mem_trainer import EvalPrediction, Trainer, set_seed
...
from ensemble_mem_modeling import RobertaForSequenceClassification
from ensemble_roberta_modeling import RobertaModel
...
def main():
    ...
    # cs = '/disk/Brucewan/MemoryBert/MemRoberta/domain_models/CS/pytorch_model.bin'
    ...
    # Loaing general model logits
    general_model_path = args.general_model + '/pytorch_model.bin'
    mem_logit_model = RobertaModel.from_pretrained(
